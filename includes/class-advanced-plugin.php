...
class Advanced_Plugin {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Advanced_Plugin_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Advanced_Plugin_Loader. Orchestrates the hooks of the plugin.
	 * - Advanced_Plugin_i18n. Defines internationalization functionality.
	 * - Advanced_Plugin_Admin. Defines all hooks for the admin area.
	 * - Advanced_Plugin_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Advanced_Plugin_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Advanced_Plugin_Loader    Orchestrates the hooks of the plugin.
	 */
